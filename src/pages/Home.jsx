...
const Home = () => {
  const jobs = [
    ...
    },
    {
      ...
      description:
        "Design and develop websites for Tasmanian and interstate businesses",
      languages: [],
      frameworks: [],
      platforms: [
    ...
    },
    {
      ...
      company: "JourneyMakr",
      description:
        "Designed and developed the front end of a travel planning web application",
      languages: [
    ...
    },
    {
      ...
      description:
        "Design web templates used for departmental data collection of COVID-19 cases",
      languages: [
        { tooltip: "CSS", icon: cssLogo },
        { tooltip: "HTML", icon: htmlLogo },
